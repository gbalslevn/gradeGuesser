...
features = student_performance.data.features[['age', 'Medu', 'Fedu', 'traveltime', 'studytime', 'goout', 'Dalc']].values # famsup og sex er fjernet for nu
targets = student_performance.data.targets.iloc[:, -1].values # Only take the last coloumn of grades. The G3 
...
nn.train(features, targets, 0.01, 1000)
